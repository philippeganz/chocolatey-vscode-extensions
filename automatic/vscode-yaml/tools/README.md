...
This project is licensed under the MIT License. See [LICENSE](https://github.com/redhat-developer/vscode-yaml/blob/HEAD/LICENSE) for details.

## Data and telemetry

When telemetry is enabled, the extension collects anonymous [usage data](https://github.com/redhat-developer/vscode-yaml/blob/HEAD/USAGE_DATA.md) and sends it to Red Hat to help improve its products and services. For more information, see Red Hat's [telemetry data collection notice](https://developers.redhat.com/article/tool-data-collection).
