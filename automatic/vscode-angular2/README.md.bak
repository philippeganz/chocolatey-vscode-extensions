...
See [CONTRIBUTING.md](https://github.com/johnpapa/vscode-angular-snippets/blob/HEAD/CONTRIBUTING.md) for guidelines on how to contribute, including submitting issues and pull requests.

For the full contributor guide, including snippet conventions and the maintenance matrix, see [AGENTS.md](https://github.com/johnpapa/vscode-angular-snippets/blob/HEAD/AGENTS.md).
