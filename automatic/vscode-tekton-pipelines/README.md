...
<div><img src="https://github.com/redhat-developer/vscode-tekton/raw/HEAD/images/gif-tekton/demo.gif" /></div><br>

# Getting Started

### Features

For more detail information around specific commands & features, please read the [plugin features](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/README.features.md) detailed guide.

### Tutorial

Follow Tekton Pipeline Extension [tutorial](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/TUTORIAL.md) inspired by [original tutorial](https://github.com/openshift/pipelines-tutorial) that uses `OpenShift Developer Console`, `tkn` and `oc` command line tools.
...
See the [change log](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/CHANGELOG.md).

## Contributing

This is an open source project open to anyone. This project welcomes contributions and suggestions!

For information on getting started, refer to the [CONTRIBUTING instructions](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/CONTRIBUTING.md).
...
MIT, See [LICENSE](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/LICENSE) for more information.

## Data and telemetry

The Red Hat OpenShift Toolkit for Visual Studio Code collects anonymous [usage data](https://github.com/redhat-developer/vscode-tekton/blob/HEAD/USAGE_DATA.md) and sends it to Red Hat servers to help improve our products and services. Read our [privacy statement](https://developers.redhat.com/article/tool-data-collection) to learn more. This extension respects the `redhat.telemetry.enabled` setting which you can learn more about at https://github.com/redhat-developer/vscode-redhat-telemetry#how-to-disable-telemetry-reporting
