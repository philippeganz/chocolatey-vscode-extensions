...
With this extension, Copilot can navigate your code at the symbol level based on your C/C++ IntelliSense configuration and build/test your project using your actual active CMake configuration, not ad-hoc command-line guesses.
