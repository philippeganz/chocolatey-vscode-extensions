...
> [!TIP]
> Please follow this [guide](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/README.crc-workflow.md) to understand the guided workflow to provision OpenShift locally.
...
> [!TIP]
> For more Serverless Functions Actions, please visit the detailed section [here](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/README.serverlessfn.md)
...
See the [change log](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/CHANGELOG.md).

## Contributing

This is an open-source project open to anyone. This project welcomes contributions and suggestions!

For information on getting started, please take a look at the [CONTRIBUTING instructions](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/CONTRIBUTING.md).
...
MIT, See [LICENSE](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/LICENSE) for more information.

## Data and telemetry

The Red Hat OpenShift Toolkit for Visual Studio Code collects anonymous [usage data](https://github.com/redhat-developer/vscode-openshift-tools/blob/HEAD/USAGE_DATA.md) and sends it to Red Hat servers to help improve our products and services. Read our [privacy statement](https://developers.redhat.com/article/tool-data-collection) to learn more. This extension respects the `redhat.telemetry.enabled` setting which you can learn more about at https://github.com/redhat-developer/vscode-redhat-telemetry#how-to-disable-telemetry-reporting.
