...
[![Visual Studio Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/johnpapa.vscode-peacock?label=Marketplace)](https://marketplace.visualstudio.com/items?itemName=johnpapa.vscode-peacock&WT.mc_id=academic-0000-jopapa)
...
Or contribute manually — see [CONTRIBUTING.md](https://github.com/johnpapa/vscode-peacock/blob/HEAD/CONTRIBUTING.md) for the full guide:

1. Fork this repo and create a branch
2. `npm install` → make your changes → `npm test`
3. Open a PR

See [AGENTS.md](https://github.com/johnpapa/vscode-peacock/blob/HEAD/AGENTS.md) for the full project guide including architecture, patterns, and how to add commands/settings.
