...
- **Factory Engine**: Automated scaffolding system (`Invoke-VsCodeExtensionFactory.ps1`) that dynamically generates offline, air-gap compliant Chocolatey packages directly from the VS Code Marketplace, including recursive dependency auto-discovery.
