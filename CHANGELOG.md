...
- Intelligent Factory Versioning: Bootstraps new packages with `0.0.0` to inherently trigger initial CI publishing, while securely preserving existing versions during mass-regeneration to prevent pipeline collisions.
